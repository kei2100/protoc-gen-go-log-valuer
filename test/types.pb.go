...
const file_test_types_proto_rawDesc = "" +
	"\n" +
	"\x10test/types.proto\x12\x06simple\x1a\x1cgoogle/protobuf/struct.proto\"\xe3\x12\n" +
	"\x05Types\x12\"\n" +
	"\n" +
	...
	"\benum_val\x18\x11 \x01(\x0e2\x12.simple.Types.EnumR\aenumVal\x128\n" +
	"\x0eother_type_val\x18\x12 \x01(\v2\x12.simple.OtherType1R\fotherTypeVal\x12@\n" +
	"\x0fnested_type_val\x18\x13 \x01(\v2\x18.simple.Types.NestedTypeR\rnestedTypeVal\x12Y\n" +
	"\x1aother_type_nested_type_val\x18\x14 \x01(\v2\x1d.simple.OtherType2.NestedTypeR\x16otherTypeNestedTypeVal\x12*\n" +
	"\x10oneof_string_val\x18\x15 \x01(\tH\x00R\x0eoneofStringVal\x12(\n" +
	"\x0foneof_int64_val\x18\x16 \x01(\x03H\x00R\roneofInt64Val\x12&\n" +
	"\x0eoneof_bool_val\x18\x17 \x01(\bH\x00R\foneofBoolVal\x125\n" +
	"\bmap_val1\x18\x18 \x03(\v2\x1a.simple.Types.MapVal1EntryR\amapVal1\x125\n" +
	"\bmap_val2\x18\x19 \x03(\v2\x1a.simple.Types.MapVal2EntryR\amapVal2\x12B\n" +
	"\rmap_empty_val\x18\x1a \x03(\v2\x1e.simple.Types.MapEmptyValEntryR\vmapEmptyVal\x12#\n" +
	"\rrepeated_val1\x18\x1b \x03(\tR\frepeatedVal1\x127\n" +
	"\rrepeated_val2\x18\x1c \x03(\x0e2\x12.simple.Types.EnumR\frepeatedVal2\x127\n" +
	"\rrepeated_val3\x18\x1d \x03(\v2\x12.simple.OtherType1R\frepeatedVal3\x12,\n" +
	...
	"\roptional_enum\x18# \x01(\x0e2\x12.simple.Types.EnumH\x03R\foptionalEnum\x88\x01\x01\x12R\n" +
	"\x19optional_not_present_enum\x18$ \x01(\x0e2\x12.simple.Types.EnumH\x04R\x16optionalNotPresentEnum\x88\x01\x01\x12B\n" +
	"\x10optional_message\x18% \x01(\v2\x12.simple.OtherType3H\x05R\x0foptionalMessage\x88\x01\x01\x12X\n" +
	"\x1coptional_not_present_message\x18& \x01(\v2\x12.simple.OtherType3H\x06R\x19optionalNotPresentMessage\x88\x01\x01\x12;\n" +
	"\x0fpresent_message\x18' \x01(\v2\x12.simple.OtherType3R\x0epresentMessage\x12B\n" +
	"\x13not_present_message\x18( \x01(\v2\x12.simple.OtherType3R\x11notPresentMessage\x1ai\n" +
	"\n" +
	"NestedType\x12*\n" +
	"\x11nested_string_val\x18\x01 \x01(\tR\x0fnestedStringVal\x12/\n" +
	"\x11nested_secret_val\x18\x02 \x01(\tB\x03\x80\x01\x01R\x0fnestedSecretVal\x1a:\n" +
	"\fMapVal1Entry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aN\n" +
	"\fMapVal2Entry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12(\n" +
	"\x05value\x18\x02 \x01(\v2\x12.simple.OtherType1R\x05value:\x028\x01\x1a>\n" +
	...
	"\x1d_optional_not_present_message\"e\n" +
	"\n" +
	"OtherType1\x12(\n" +
	"\x10other_string_val\x18\x01 \x01(\tR\x0eotherStringVal\x12-\n" +
	"\x10other_secret_val\x18\x02 \x01(\tB\x03\x80\x01\x01R\x0eotherSecretVal\"w\n" +
	"\n" +
	"OtherType2\x1ai\n" +
	"\n" +
	"NestedType\x12*\n" +
	"\x11nested_string_val\x18\x01 \x01(\tR\x0fnestedStringVal\x12/\n" +
	"\x11nested_secret_val\x18\x02 \x01(\tB\x03\x80\x01\x01R\x0fnestedSecretVal\"\x1e\n" +
	"\n" +
	"OtherType3\x12\x10\n" +
	"\x03val\x18\x01 \x01(\tR\x03valB2Z0github.com/kei2100/protoc-gen-go-log-valuer/testb\x06proto3"
